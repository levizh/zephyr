...
#define HC32_DMA_SOURCE_ADDR_FIX             HC32_DMA_CH_CFG_SOURCE_ADDR_INC(0)
#define HC32_DMA_SOURCE_ADDR_INC             HC32_DMA_CH_CFG_SOURCE_ADDR_INC(1)
#define HC32_DMA_SOURCE_ADDR_DEC             HC32_DMA_CH_CFG_SOURCE_ADDR_INC(2)

/* dest address increase defined on bits 8-9 */
#define HC32_DMA_CH_CFG_DEST_ADDR_INC(val)  ((val & 0x3) << 8)
#define HC32_DMA_DEST_ADDR_FIX              HC32_DMA_CH_CFG_DEST_ADDR_INC(0)
#define HC32_DMA_DEST_ADDR_INC              HC32_DMA_CH_CFG_DEST_ADDR_INC(1)
#define HC32_DMA_DEST_ADDR_DEC              HC32_DMA_CH_CFG_DEST_ADDR_INC(2)
