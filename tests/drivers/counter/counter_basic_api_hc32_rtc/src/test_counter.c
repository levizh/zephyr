...
#ifdef DT_XHSC_HC32_RTC_0_LABEL
...
#elif defined(CONFIG_COUNTER_RTC_HC32)
#define COUNTER_PERIOD_US      (USEC_PER_SEC * 2U)
#define COUNTER_PERIOD_US_LONG (USEC_PER_SEC * 60U)
#else
...
#ifdef DT_XHSC_HC32_TIMERA_COUNTER_0_LABEL
    DT_XHSC_HC32_TIMERA_COUNTER_0_LABEL,
#endif

#ifdef DT_XHSC_HC32_TIMERA_COUNTER_1_LABEL
    DT_XHSC_HC32_TIMERA_COUNTER_1_LABEL,
#endif

#ifdef DT_XHSC_HC32_TIMERA_COUNTER_2_LABEL
    DT_XHSC_HC32_TIMERA_COUNTER_2_LABEL,
#endif

#ifdef DT_XHSC_HC32_TIMERA_COUNTER_3_LABEL
    DT_XHSC_HC32_TIMERA_COUNTER_3_LABEL,
#endif

#ifdef DT_XHSC_HC32_TIMERA_COUNTER_4_LABEL
    DT_XHSC_HC32_TIMERA_COUNTER_4_LABEL,
#endif

#ifdef DT_XHSC_HC32_TIMERA_COUNTER_5_LABEL
    DT_XHSC_HC32_TIMERA_COUNTER_5_LABEL,
#endif
};
...
void test_single_shot_alarm_instance(const char *dev_name, bool set_top, u32_t alarm_period_us)
{
	struct device *dev;
	int err;
	u32_t ticks;
	...
	k_sleep(1.1*counter_ticks_to_us(dev, ticks)/1000);
...
{
	test_single_shot_alarm_instance(dev_name, false, COUNTER_PERIOD_US);
	test_single_shot_alarm_instance(dev_name, false, COUNTER_PERIOD_US_LONG);
}

void test_single_shot_alarm_top_instance(const char *dev_name)
{
	test_single_shot_alarm_instance(dev_name, true, COUNTER_PERIOD_US);
}
