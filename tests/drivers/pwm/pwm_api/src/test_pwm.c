...
#define DEFAULT_PERIOD_NSEC 2000000
#define DEFAULT_PULSE_NSEC 500000
#elif DT_HAS_COMPAT_STATUS_OKAY(xhsc_hc32_timera_pwm)
#define DEFAULT_PERIOD_CYCLE 64000
#define DEFAULT_PULSE_CYCLE  20000
#define DEFAULT_PERIOD_CYCLE2 56000
#define DEFAULT_PULSE_CYCLE2  40000
#define DEFAULT_PERIOD_NSEC 65000
#define DEFAULT_PULSE_NSEC  50000
#elif DT_HAS_COMPAT_STATUS_OKAY(xhsc_hc32_timer6_pwm)
#define DEFAULT_PERIOD_CYCLE 64000
#define DEFAULT_PULSE_CYCLE  20000
#define DEFAULT_PERIOD_CYCLE2 56000
#define DEFAULT_PULSE_CYCLE2  40000
