...
#define PWM_DEV_NAME DT_XHSC_HC32_TIMERA_PWM_0_LABEL
#endif
...
#define DEFAULT_PULSE_CYCLE 40000
#define DEFAULT_PERIOD_USEC 500
#define DEFAULT_PULSE_USEC 100
#define DEFAULT_PERIOD_NSEC 200000
#define DEFAULT_PULSE_NSEC 20000
#else
#define DEFAULT_PERIOD_CYCLE 64000
